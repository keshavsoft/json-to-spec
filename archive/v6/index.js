 ...
 * json-to-spec v6
 *
 * The compiler story is intentionally simple:
 * - story data stays in the JSON model
 * - the compiler resolves values and expands iterations
 * - a dedicated story injector adds narrative nodes without cluttering the core tree
 */
